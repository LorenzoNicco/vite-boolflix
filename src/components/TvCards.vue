            ...
            <div v-else class="card-container">
                <div class="card-yes"  v-for="show in store.tvSeries">
                    <div class="card-commons card-info">
                        <ul>
                            <li>
                                <h3>Titolo: {{ show.name }}</h3>
                            </li>
                            <li v-show="show.original_name != show.name">
                                <h4>Titolo originale: {{ show.original_name }}</h4>
                            </li>
                            ...
                            <li v-else><strong>Voto:</strong> 
                                <font-awesome-icon class="star-icon" v-for="n in store.voteConverter(show)" icon="fa-solid fa-star" />
                                <font-awesome-icon class="star-icon" v-for="n in (5 - store.voteConverter(show))" icon="fa-regular fa-star" />
                            </li>
